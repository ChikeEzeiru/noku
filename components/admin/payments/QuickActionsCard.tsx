function ReceiptIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" opacity="0.8" stroke="currentColor" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round">
...
function BellIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" opacity="0.8" stroke="currentColor" strokeWidth="1.39" strokeLinecap="round" strokeLinejoin="round">
    ...
    <div className="bg-white border border-[#e5e5e5] rounded-xl p-6 flex flex-col gap-5" style={{ boxShadow: "0 1px 2px rgba(0,0,0,0.05)" }}>
      ...
      <div className="flex flex-col gap-3">
        {actions.map((action, i) => (
          <button
            key={i}
            className="text-left flex items-center gap-3 border border-[#e5e5e5] rounded-xl p-4 hover:bg-[#fafafa] transition-colors"
            style={{ boxShadow: "0 1px 1px rgba(0,0,0,0.04)" }}
          >
            <div className="w-10 h-10 rounded-lg border border-[#e5e5e5] flex items-center justify-center text-[#404040] shrink-0" style={{ boxShadow: "0 1px 2px rgba(0,0,0,0.05)" }}>
              {action.icon}
            </div>
